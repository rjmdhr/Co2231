...
//  This class was modified and finished as part of Assignment 4 Quesiton 1
/*****************************************************************************/
 ...
 * Some methods were modified and finished as programming assignments 
...
public class LinkedBinaryTree<T> implements BinaryTreeADT<T>, Iterable<T>
{
	...
	public int size() 
	{
		...
		// use inorder Iterator to count number of nodes in this tree
	...
	private int height(BinaryTreeNode<T> node) 
	{
		...
		// return left height if greater than right, else right
	...
	{
		// use inOrder method to add to a new ArrayUnorderedList
